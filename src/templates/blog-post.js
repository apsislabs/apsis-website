    ...
    <Layout>
      ...
      <ContentBlock vertical={true}>
        ...
        <div className={BlogPostStyles.post}>
          ...
          />
          <small className={BlogPostStyles.post__credit}>
            Image by: {post.frontmatter.credit}
          </small>
          <div className={BlogPostStyles.post__content}>
            <h1>
              <div className={BlogPostStyles.post__title}>
        ...
        <AuthorBlock name={post.frontmatter.author} />
      </ContentBlock>
    </Layout>
  );
}
