      ...
      <StaticQuery
        query={graphql`
          query {
            strato: file(
              relativePath: {
                eq: "images/portfolio/stratolaunch/strato_screens.png"
              }
            ) {
              childImageSharp {
                fluid(maxWidth: 1200) {
            ...
            tb: file(
              relativePath: {
                eq: "images/portfolio/thinkingbaseball/iphone_frame.png"
              }
            ) {
              childImageSharp {
                fluid(maxWidth: 300) {
            ...
            tbImg: file(
              relativePath: {
                eq: "images/portfolio/thinkingbaseball/tb_home.png"
              }
            ) {
              childImageSharp {
                fluid(maxWidth: 300) {
            ...
            tbVideo: file(
              relativePath: {
                eq: "images/portfolio/thinkingbaseball/tb_bg_video.mp4"
              }
            ) {
              publicURL
            }
            dolby: file(
              relativePath: { eq: "images/portfolio/dolby/dolby_screens.png" }
            ) {
              childImageSharp {
                fluid(maxWidth: 1000) {
                  ...GatsbyImageSharpFluid
        ...
        render={data => (
          <Layout>
            ...
            >
              ...
              <Button className={blueWideButtonClasses} to="/process">
                See Our Process
              </Button>
              {/* <Animated animationIn="fadeInUp">
            ...
            <ContentBlock vertical={true}>
              <div className={portfolioStyles.verticalContainer}>
                ...
                <p>
                  <a
                    href="https://www.stratolaunch.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Stratolaunch.com
                  </a>{" "}
                  is the primary home page for Stratolaunch, the Seattle-based
                  space launch company founded by Paul Allen.
                </p>
              </div>
            </ContentBlock>
            ...
            <DiagonalBackground>
              <div className={portfolioStyles.container}>
                <div
                  ...
                  style={{
                    backgroundImage: `url(${data.tb.childImageSharp.fluid.src})`
                  }}
                >
                  <img
                    src={data.tbImg.childImageSharp.fluid.src}
                ...
                <div className={portfolioStyles.content}>
                  ...
                  <p>
                    <a
                      href="https://www.thinkingbaseball.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Thinking Baseball
                    </a>{" "}
                    is a mobile app for iOS and Android designed to teach young
                    players to master the mental side of baseball. The
                    application was built in three parts: a shared C# codebase
                    for the game experience; native frontends for iOS and
                    Android implemented in C# using the Xamarin SDK; and a Ruby
                    on Rails web service for user authentication, permissions,
                    e-commerce transactions, and licensing. The mobile apps are
                    available for free on the{" "}
                    <a
                      href="https://itunes.apple.com/us/app/thinkingbaseball/id1221028028"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Apple App Store
                    ...
                    and{" "}
                    <a
                      href="https://play.google.com/store/apps/details?id=com.thinkingbaseball.app"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Google Play Store
            ...
            <ContentBlock vertical={true}>
              <div className={portfolioStyles.verticalContainer}>
                <Img fluid={data.dolby.childImageSharp.fluid} alt="Signal" />
                <h2>Signal</h2>
                <p>
                  <a
                    href="https://hub.dolby.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Signal
                  </a>{" "}
                  is the narrative hub of Dolby's technology brand. Built on
                  WordPress, the custom website uses a slew of cutting-edge web
                  technologies. Using our own open-source set of plugins, the
                  Signal site also shows the flexibility and power of WordPress
                  as a CMS.
                </p>
              </div>
            </ContentBlock>
