...
export default () => (
  <Layout>
    ...
    <Header title="Let’s build something">
      <h3>
        Got a project? Just wanna talk shop? <br /> We’re always listening.
      </h3>
    </Header>
    <ContentBlock vertical={true}>
      <form
        ...
        method="POST"
        action="https://a17eeo6v24.execute-api.us-west-2.amazonaws.com/contactformapi"
      >
        <span>
          <input
            type="text"
            ...
            className={contactStyles.form__input}
          />
        </span>
        <span>
          <input
      ...
      <span className={contactStyles.bottomText}>
        ...
        <p />
        Want to know more before you contact us?{" "}
        <Link to="/process">Read about our process.</Link>
      </span>
    </ContentBlock>
  </Layout>
);
